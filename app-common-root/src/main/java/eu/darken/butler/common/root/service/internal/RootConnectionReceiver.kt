...
abstract class RootConnectionReceiver(private val pairingCode: String) {
    ...
    companion object {
        const val BROADCAST_ACTION = "eu.darken.butler.common.root.service.internal.RootIPCReceiver.BROADCAST"
        const val BROADCAST_EXTRA = "eu.darken.butler.common.root.service.internal.RootIPCReceiver.BROADCAST.EXTRA"
