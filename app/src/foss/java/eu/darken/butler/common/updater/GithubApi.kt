...
import eu.darken.butler.common.serialization.OffsetDateTimeSerializer
...
interface GithubApi {
    ...
    data class ReleaseInfo(
        ...
        @SerialName("published_at") val publishedAt: @Serializable(with = OffsetDateTimeSerializer::class) OffsetDateTime,
