            ...
            storageManager2.storageVolumes
                ...
                .mapNotNull { volume ->
                    ...
                    val label = when (volume.isRemovable) {
                        true -> R.string.storage_area_sdcard_label.toCaString()
                        else -> R.string.storage_area_public_label.toCaString()
                    }
        ...
        if (hasApiLevel(30) && !hasApiLevel(33)) {
            ...
            storageEnvironment.externalDirs
                ...
                .mapNotNull { targetPath ->
                    ...
                    Result.PathAccess(
                        label = R.string.storage_area_public_app_data_label.toCaString(),
                        safPath = safPath,
                        localPath = targetPath,
                        uriPermission = matchedPermission?.permission,
