...
fun AcknowledgementsScreen(
    ...
    Scaffold(
        ...
        LazyColumn(
            ...
            item {
                SettingsCategoryHeader(stringResource(R.string.settings_acks_thanks_header))
            }
            ...
            item {
                SettingsCategoryHeader(stringResource(R.string.settings_licenses_label))
            }
            ...
            item {
                SettingsBaseItem(
                    ...
                    subtitle = "Run rooted Kotlin JVM code made easy with coroutines. (APACHE 2.0)",
            ...
            item {
                SettingsBaseItem(
                    title = "Shizuku",
                    subtitle = "Using system APIs directly with adb/root privileges from normal apps through a Java process started with app_process. (APACHE 2.0)",
