...
fun LightThemePreview() =
        MyAppTheme(state = ThemeState(mode = ThemeMode.LIGHT, style = ThemeStyle.DEFAULT)) {
            SampleContent()
        }

@Preview(showBackground = true, name = "Dark Mode")
@Composable
fun DarkThemePreview(): Unit =
        MyAppTheme(state = ThemeState(mode = ThemeMode.DARK, style = ThemeStyle.DEFAULT)) {
            SampleContent()
        }
...
fun MaterialYouLightThemePreview() =
        MyAppTheme(state = ThemeState(mode = ThemeMode.LIGHT, style = ThemeStyle.MATERIAL_YOU)) {
            SampleContent()
        }
...
fun MaterialYouDarkThemePreview() =
        MyAppTheme(state = ThemeState(mode = ThemeMode.DARK, style = ThemeStyle.MATERIAL_YOU)) {
            SampleContent()
        }
