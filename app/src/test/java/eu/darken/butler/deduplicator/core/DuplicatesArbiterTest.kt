package eu.darken.butler.deduplicator.core

import eu.darken.butler.deduplicator.core.arbiter.DuplicatesArbiter
import eu.darken.butler.deduplicator.core.arbiter.checks.DuplicateTypeCheck
import eu.darken.butler.deduplicator.core.arbiter.checks.LocationCheck
import eu.darken.butler.deduplicator.core.arbiter.checks.MediaProviderCheck
import eu.darken.butler.deduplicator.core.arbiter.checks.ModificationCheck
import eu.darken.butler.deduplicator.core.arbiter.checks.NestingCheck
import eu.darken.butler.deduplicator.core.arbiter.checks.SizeCheck
import eu.darken.butler.deduplicator.core.scanner.checksum.ChecksumDuplicate
import eu.darken.butler.deduplicator.core.scanner.phash.PHashDuplicate
