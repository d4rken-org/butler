package eu.darken.butler.appcleaner.core.forensics

import android.content.Context
import android.content.res.AssetManager
import eu.darken.butler.appcleaner.core.forensics.sieves.DynamicAppSieve2
import eu.darken.butler.appcleaner.core.forensics.sieves.JsonAppSieve
...
import eu.darken.butler.common.forensics.FileForensics
    ...
    open fun setup() {
        ...
        storageEnvironment.apply {
            ...
            every { ourCacheDirs } returns listOf(
                LocalPath.build("/data/data/eu.darken.butler/cache")
            )
            every { ourExternalCacheDirs } returns listOf(
                LocalPath.build("/storage/emulated/0/Android/data/eu.darken.butler/cache"),
                LocalPath.build("/storage/ABCD-1234/Android/data/eu.darken.butler/cache"),
            )
            every { ourCodeCacheDirs } returns listOf(
                LocalPath.build("/data/data/eu.darken.butler/code_cache")
            )
        }
