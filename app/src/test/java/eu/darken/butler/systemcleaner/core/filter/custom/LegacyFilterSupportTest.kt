package eu.darken.butler.systemcleaner.core.filter.custom
    ...
    fun `import SD Maid 1 legacy v5 filter`() = runTest {
        val rawLegacyFilter = """
            {
                ...
                "mainPath": [
                    ...
                    "/storage/emulated/0/eu.darken.butler-test-area-access",
                    "/storage/emulated/0/eu.darken.butler-test-area-access"
                ],
                "maximumAge": 999999,
                "maximumSize": 9001,
        ...
        importedFilter!!.apply {
            ...
            pathCriteria shouldBe setOf(
                ...
                SegmentCriterium(
                    segments = segs("", "storage", "emulated", "0", "eu.darken.butler-test-area-access"),
                    mode = SegmentCriterium.Mode.Start(allowPartial = true, ignoreCase = true),
                ),
                SegmentCriterium(
                    segments = segs("", "storage", "emulated", "0", "eu.darken.butler-test-area-access"),
