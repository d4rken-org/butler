...
class GplayServiceUnavailableException(cause: Throwable) :
    ...
    override fun getLocalizedError(context: LocalizedErrorContext): LocalizedError {
        ...
        return LocalizedError(
            ...
            // The failure is not presented here: it propagates to the dialog/card, which renders this
            // inline. A Toast caps at 2 lines and clipped this message, so the container was the
