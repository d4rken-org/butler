...
fun AppsDialogHost(
    ...
    onViewStyleApplyToTab: (AppsViewStyle) -> Unit,
    onViewStyleApplyToAllTabs: (AppsViewStyle) -> Unit,
    onViewStyleSetAsDefault: (AppsViewStyle) -> Unit,
    ...
    when (dialogState) {
        ...
        is AppsDialogState.ViewStyleOptions -> {
