...
class BufferedLoggerTest : BaseTest() {
    ...
    @Test
    fun `excluded tag prefix Developer Workspace is filtered`() {
        val logger = BufferedLogger()

        logger.log(Priority.INFO, "BTLR:Developer:Workspace:abc:Page", "Should be filtered", null)
    ...
    @Test
    fun `excluded tag prefix Developer LogRepo is filtered`() {
        val logger = BufferedLogger()

        logger.log(Priority.INFO, "BTLR:Developer:LogRepo", "Should be filtered", null)
        logger.log(Priority.INFO, "BTLR:Other:Tag", "Should pass", null)
    ...
    @Test
    fun `excluded tag prefix Developer TestDataGenerator is filtered`() {
        val logger = BufferedLogger()

        logger.log(Priority.INFO, "BTLR:Developer:TestDataGenerator", "Should be filtered", null)
        logger.log(Priority.INFO, "BTLR:Other:Tag", "Should pass", null)
