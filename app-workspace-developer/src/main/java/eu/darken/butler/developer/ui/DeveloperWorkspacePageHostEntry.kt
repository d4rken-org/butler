...
object DeveloperWorkspacePageHostEntry : WorkspacePageHostEntry {

    @Composable
    override fun Content(id: Workspace.Id, design: WorkspaceDesign) {
        DeveloperWorkspacePageHost(id = id, design = design)
    }

    @Composable
    override fun Overlays(id: Workspace.Id, design: WorkspaceDesign) {
        DeveloperWorkspaceOverlaysHost(id = id)
    }
    ...
    object PageHostModule {
        ...
        fun entry(): WorkspacePageHostEntry = DeveloperWorkspacePageHostEntry
    }
}
