    ...
    Column(modifier = Modifier.fillMaxSize()) {
                            ...
                            label = {
                                Text(
                                    text = when (tab) {
                                        ...
                                        DebugTab.OPTIONS -> stringResource(R.string.debug_tab_options)
        ...
        Box(
            ...
            when (state.selectedTab) {
                ...
                DebugTab.OPTIONS -> OptionsSection(
...
private fun OptionsSection(
    optionsState: DebugWorkspaceViewModel.OptionsState,
    onToggleDebugMode: (Boolean) -> Unit,
    onToggleTraceMode: (Boolean) -> Unit,
    onTestRoot: () -> Unit,
    onTestShizuku: () -> Unit,
    ...
    LazyColumn(
        ...
        // Debug Options Card
        item {
            SectionCard(title = stringResource(R.string.debug_options_debug_header)) {
                DebugToggleRow(
                    title = stringResource(R.string.debug_options_debug_mode),
                    description = stringResource(R.string.debug_options_debug_mode_desc),
                    checked = optionsState.isDebugMode,
                    onCheckedChange = onToggleDebugMode,
                )
                DebugToggleRow(
                    title = stringResource(R.string.debug_options_trace_mode),
                    description = stringResource(R.string.debug_options_trace_mode_desc),
        ...
        // Service Tests Card
        item {
            SectionCard(title = stringResource(R.string.debug_options_services_header)) {
                ServiceTestRow(
                    title = stringResource(R.string.debug_options_root_test_action),
                ...
                ServiceTestRow(
                    title = stringResource(R.string.debug_options_shizuku_test_action),
                ...
                optionsState.shizukuTestResult?.let { result ->
                    ServiceResultCard(
                        items = listOf(
                            stringResource(R.string.debug_options_shizuku_installed_label) to result.isInstalled.toResultString(),
                            stringResource(R.string.debug_options_shizuku_granted_label) to result.isGranted.toResultString(),
                            stringResource(R.string.debug_options_shizuku_compatible_label) to result.isCompatible.toResultString(),
                            stringResource(R.string.debug_options_shizuku_service_label) to result.isServiceAvailable.toResultString(),
                        ),
    ...
    Row(
        ...
        OutlinedButton(
            ...
            if (isTesting) {
                ...
                Spacer(modifier = Modifier.width(8.dp))
                Text(text = stringResource(R.string.debug_options_test_running))
            } else {
                Text(text = title)
            }
        }
...
private fun Boolean.toResultString(): String = if (this) {
    stringResource(R.string.debug_options_result_yes)
} else {
...
private fun Boolean?.toResultString(): String = when (this) {
    true -> stringResource(R.string.debug_options_result_yes)
    false -> stringResource(R.string.debug_options_result_no)
    null -> stringResource(R.string.debug_options_result_unknown)
}
