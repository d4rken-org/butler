...
fun <T : Any> IBinder.getInterface(clazz: KClass<T>): T? {
    ...
    // e.g. eu.darken.butler.common.root.service.RootServiceConnection.DESCRIPTOR
    ...
    // e.g. eu.darken.butler.common.shizuku.ShizukuServiceConnection$Stub$Proxy.<init> [interface android.os.IBinder]
