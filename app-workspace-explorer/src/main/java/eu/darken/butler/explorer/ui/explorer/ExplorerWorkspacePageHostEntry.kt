...
object ExplorerWorkspacePageHostEntry : WorkspacePageHostEntry {

    @Composable
    override fun Content(id: Workspace.Id, design: WorkspaceDesign) {
        ExplorerWorkspacePageHost(id = id, design = design)
    }

    @Composable
    override fun Overlays(id: Workspace.Id, design: WorkspaceDesign) {
        ExplorerWorkspaceOverlaysHost(id = id, design = design)
    }
    ...
    object PageHostModule {
        ...
        fun entry(): WorkspacePageHostEntry = ExplorerWorkspacePageHostEntry
    }
}
