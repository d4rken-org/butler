...
fun TrashSizeLimitIssueSheet(
    ...
    Column(
        ...
        Text(
            text = stringResource(R.string.explorer_issue_trash_size_limit_file_label),
        ...
        OutlinedButton(
            ...
            Row(
                ...
                Text(
                    text = stringResource(R.string.explorer_issue_common_delete_permanently),
                    maxLines = 1,
...
private fun TrashSizeLimitIssueSheetPreview() {
    PreviewWrapper {
        TrashSizeLimitIssueSheet(
            issue = MockDataProvider.createMockTrashSizeLimitIssue(),
            onResolution = {},
        )
    }
}
