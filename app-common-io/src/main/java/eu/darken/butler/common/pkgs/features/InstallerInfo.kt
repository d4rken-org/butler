...
import eu.darken.butler.common.pkgs.toKnownPkg
...
data class InstallerInfo(
    ...
    fun getLabel(context: Context): String {
        if (installer == null) {
            return context.getString(eu.darken.butler.common.R.string.general_na_label)
        }
    ...
    fun getIcon(context: Context): Drawable {
        if (installer == null) return ContextCompat.getDrawable(context, R.drawable.ic_user_24)!!
