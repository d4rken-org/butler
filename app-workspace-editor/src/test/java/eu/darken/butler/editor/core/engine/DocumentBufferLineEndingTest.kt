...
/**
 * TDD tests for CRLF and line ending support in DocumentBuffer.
 * These tests define the expected behavior before implementation.
 */
class DocumentBufferLineEndingTest : DocumentBufferTestBase() {
    ...
    fun `search in CRLF file returns correct positions`() = runTest {
        ...
        val results = buffer.search("Hello", options = SearchOptions(caseSensitive = true))
    ...
    // `save file maintains CRLF line endings` — successful save of a modified buffer.
}
