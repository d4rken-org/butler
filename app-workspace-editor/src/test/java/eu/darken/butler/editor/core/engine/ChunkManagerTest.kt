...
class ChunkManagerTest : BaseTest() {
    ...
    fun `mergeChunks with single chunk modification at start`() {
        ...
        val dirtyChunk = TextChunk(
            id = TextChunk.ChunkId.generate(0),
            startOffset = 0L,
            endOffset = 5L,
            content = "HELLO",
            lineCount = 1,
    ...
    fun `mergeChunks with single chunk modification in middle`() {
        ...
        val dirtyChunk = TextChunk(
            id = TextChunk.ChunkId.generate(6),
            startOffset = 6L,
            endOffset = 11L,
            content = "There",
            lineCount = 1,
    ...
    fun `mergeChunks with multiple non-overlapping chunks`() {
        ...
        val chunk2 = TextChunk(
            id = TextChunk.ChunkId.generate(10),
            startOffset = 10L,
            endOffset = 14L,
            content = "3333",
            lineCount = 1,
    ...
    fun `mergeChunks with adjacent dirty chunks`() {
        ...
        val chunk2 = TextChunk(
            id = TextChunk.ChunkId.generate(5),
            startOffset = 5L,
            endOffset = 9L,
            content = "2222",
            lineCount = 1,
    ...
    fun `mergeChunks with gaps between dirty chunks preserves unchanged content`() {
        ...
        val chunk2 = TextChunk(
            id = TextChunk.ChunkId.generate(15),
            startOffset = 15L,
            endOffset = 19L,
            content = "4444",
            lineCount = 1,
    ...
    fun `mergeChunks with multiline content`() {
        ...
        // Replace second line
        val dirtyChunk = TextChunk(
            id = TextChunk.ChunkId.generate(7),
            startOffset = 7L,
    ...
    fun `getDirtyChunks returns only dirty chunks`() = runTest {
        ...
        val dirtyChunk = TextChunk(
            id = TextChunk.ChunkId.generate(100),
            startOffset = 100L,
            endOffset = 200L,
            content = "Dirty",
            lineCount = 1,
        ...
        val cleanChunk2 = TextChunk(
            id = TextChunk.ChunkId.generate(200),
            startOffset = 200L,
            endOffset = 300L,
            content = "Clean 2",
            lineCount = 1,
