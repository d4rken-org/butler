 ...
 */
class DocumentBufferEditTest : DocumentBufferTestBase() {
    ...
    // `saveFile after edit attempts save` — successful save of a modified buffer.
    // `saveFile with empty chunks maintains structure` — successful save after edits.
}
