 ...
 *
 * Both are Static bars whose fraction is never recorded, but the key still has to stay unique within
 * its stack, and a later behaviour change would silently start persisting it under whatever name it
 * has by then.
 */
