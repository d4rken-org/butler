...
fun MaxHistoryItemsDialog(
    ...
    AlertDialog(
        ...
        title = {
            Text(
                text = stringResource(R.string.history_settings_max_history_label),
        ...
        text = {
            Column {
                OutlinedTextField(
                    ...
                    label = { Text(stringResource(R.string.history_settings_max_history_input_label)) },
                    ...
                    keyboardActions = KeyboardActions(
                        onDone = { if (!isError) onConfirm(sliderValue.toInt()) }
                    ),
                )
                Slider(
                    value = sliderValue,
