 ...
 * up would otherwise leave a dialog that cancels nothing, so a pending id that is gone from
 * [operations] or no longer cancelable takes its own confirmation down.
 */
@Composable
